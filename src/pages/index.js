...
export default function Home() {
  return (
    <>
      <Head>
        <title>Home | Birhanu Kabito </title>
          ...
          <div className='flex items-center justify-between w-full lg:flex-col'>
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                ...
                '
                download={true}
                href='/birhanu_kabito_cv.pdf' target={'_blank'}>Resume  <LinkArrow className='w-6 ml-1'/> </Link>
                <Link href='mailto:berhanukebito05@gmail.com' target={'_blank'}  className='ml-4 text-lg font-medium capitalize text-dark underline dark:text-light md:text-base' >Contact</Link>
              </div>
            </div>
