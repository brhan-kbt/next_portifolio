...
import eonline from '../../public/images/projects/eaglopia.jpg'
import keradion from '../../public/images/projects/keradion.jpg'
    ...
    <main className='w-full flex flex-col items-center justify-center dark:text-light'>
        <Layout className='pt-16'>
            ...
            <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                ...
                <div className='col-span-12'>
                    <FeaturedProject
                    title='Keradion Designs Solutions'
                    link='https://www.keradiondesigns.com'
                    summary="Keradion Designs, the preferred partner
                    for top Ethiopian enterprises, specializes in bespoke
                     software development, innovative product design,
                     and expert consultancy.

                    Keradion Designs is dedicated to delivering
                    tailored solutions that enhance business value
                     and showcase their cutting-edge technological
                      expertise.
